        ...
        for i, line in enumerate(read_file):
            try:
                ...
                try:
                    ...
                    print(f"\nError loading line {i} from '{log_name}': date in unexpected format. Data excluded from output.")
            except json.JSONDecodeError:
                print(f"\nError loading line {i} from '{log_name}': data not in valid JSON format. Data excluded from output.")
...
if __name__ == "__main__":
    while True:
        ...
        for log_name in tqdm(log_file_paths, total=len(log_file_paths)):
